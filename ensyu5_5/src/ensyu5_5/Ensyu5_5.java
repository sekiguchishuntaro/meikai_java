...
public class Ensyu5_5 {
	...
	/*
	 * 関数名：main
	 * メソッドの説明：三つの整数値を読み込んで、その合計とキャスト演算子を利用した平均を表示するプログラム
	 * 引数：なし
	 * 戻り値：なし
	 * 作成者：関口駿太郎
	 * 作成日：2023.04.21
	...
	public static void main(String[] args) {
		...
		double averageValue = (double) (firstNumber + secondNumber + thirdNumber) / 3.0;
		...
		System.out.printf ("firstNumberとsecondNumberとthirdNumberの平均は" + averageValue + "です。");
